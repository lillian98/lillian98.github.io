    ...
    App.Opa = App.Opa || Opa, Opa.prototype = {init: function () {
        ...
        function exchange(ev) {
            function moveHandler(ev) {
                ...
                setTimeout(function(){App.Utils.removeClass(document.querySelector("#J_opaPage"), 'float-show-hide'),App.Utils.removeClass(document.querySelector("#J_opaPage"), 'float-show')},200);
            }

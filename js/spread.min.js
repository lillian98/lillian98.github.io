                    ...
                    //else{                                      
                        ...
                        if(Math.abs(disy)>20){
                            ...
                            if(disy>0){
                                ...
                                if(curDom.hasAttribute('data-sec-last')) {_this.set("sec-prevent",!1);guideDom.style.zIndex = -1;return false;}
                                guideDom.style.zIndex = 999;
...
//                console.log('end in ',ev.target,this,next)
                if(document.querySelector("#J_opaPage").className.indexOf('float-show')>-1 && document.querySelector("#J_opaPage").className.indexOf('float-show-') <0){
                    ev.preventDefault();
//                    console.log('end has float',ev.target,this);
                    if(curDom == null || curDom == 'undefined'){
                         _this.set("prevent", !1);
                       ...
                       posObj = ev.changedTouches ? ev.changedTouches[0] : ev, move.y = posObj.clientY || posObj.pageY, disy = move.y - start.y;
                        if(next){                            
                            ...
                            if(next.hasAttribute('data-sec-last')) {guideDom.style.zIndex = -1;}
                            if(Math.abs(disy) > 20){
                                ...
                                if(curDom.hasAttribute('data-sec-last')) {guideDom.style.zIndex = -1;}
                ...
                /* S 没有二级页面 */
                    ...
                    setTimeout(function(){target.hasAttribute('data-last')?guideDom.style.zIndex = -1:guideDom.style.zIndex = 999},300);
                }
                /* E 没有二级页面 */
            }            
            if(document.querySelector("#J_opaPage").className.indexOf('float-show')>-1 && document.querySelector("#J_opaPage").className.indexOf('float-show-') <0){
//                console.log('exchage in float-show',_this.get("prevent"));
